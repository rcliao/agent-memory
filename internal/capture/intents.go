...
var intents = []intent{
	...
	{"health", 0.26, regexp.MustCompile(`(?i)(?:allergic|nauseous|dizzy|fever|headache|injured|bleeding|rash|threw up)|拉肚子|不舒服|受傷|切到|流血|發燒|頭痛|想吐|過敏|起疹|紅疹|癢|(?:頭|肚子|喉嚨|牙|背|腰|胃)(?:有點|好|很|超|悶)?痛|中暑|吃了.{0,6}(?:藥|止痛)|藥膏|消了|痊癒|好多了|退燒`)},
