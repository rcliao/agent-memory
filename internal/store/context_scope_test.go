...
func TestSessionScope_MatchesAndBoost(t *testing.T) {
	...
	mem := model.Memory{
		Tags:      []string{"meal-memo", "chat:800000001", "date:2026-05-12"},
	...
	cases := []struct {
		...
		},
		{
			...
			scope:     &SessionScope{Tags: []string{"chat:800000001"}, BoostFactor: 2.5},
			wantBoost: 2.5,
		},
		{
			name:      "tag match — date",
		...
		},
		{
			...
			scope:     &SessionScope{Tags: []string{"chat:800000001"}, BoostFactor: 1.0},
			wantBoost: 1.0,
		},
	}
