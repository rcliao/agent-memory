...
|-------|------|-------------|---------|
| **ns** | string | Hierarchical namespace (`:` separated) | `identity`, `lore`, `user:ev`, `shell:chat:800000001` |
...
|---------|---------|---------|
| `<app>:chat:<id>` | Per-conversation memories | `shell:chat:800000001` |
| `<app>:heartbeat:<id>` | Periodic reflection learnings | `shell:heartbeat:800000001` |
...
```bash
ghost put -n "shell:chat:800000001" -k "deploy-2026-03-01" --kind episodic \
