...
| `ghost_patch` | Write | Apply a unified diff to a memory's content, context-verified against the version it was generated from (safer than `ghost_put` for edits) |
